...
# def fun(*args, **kwargs):
#     print(kwargs['hello'][4])
# pet=[1,2,3,4,56,6]
# fun([2,3,4,2,4,5,6],'Hello', hello = pet, qwerty = 555)
...
# print(foods['food1']['cost']+foods['food2']['cost']+foods['food3']['cost']+foods['food4']['cost']+foods['food5']['cost'])
...
#     {'name': 'Jennifer', 'age': 16, 'course': 'C', 'gender': 'Female'}, 
...
#     {'name': 'Nicolas', 'age': 19, 'course': 'C#', 'gender': 'Male'}, 
#     {'name': 'Alex', 'age': 21, 'course': 'C++', 'gender': 'Male'}, 
...
#     {'name': 'Steve', 'age': 26, 'course': 'C++', 'gender': 'Male'}, 
#     {'name': 'Mark', 'age': 18, 'course': 'java', 'gender': 'Male'}, 
...
# params = f'host=localhost dbname=itc user=postgres password = '
